    		...
    		<div className="container-fluid">
	    		<div className="Heading">
	      		...
	      		<div className="container-fluid" style={{textAlign: 'center'}}>
		      		...
		      		<div className="col-md-3" style={{height: '365px', widht: '150px', border:'2px solid #c2073f'}}>
		      			<div className="row">
			      		...
			      		<div className="row">
      						...
      						<div className="col-md-10 col-xs-10">
      							<h4 style={{textAlign:'left'}}>Ordinary cloths</h4>
			      					...
			      					<div className="row">
				      					<div className="col-md-12" style={{backgroundColor:'#c2073f',marginTop:'41px'}}>
		      		...
		      		<div className="col-md-2"></div>
		      			<div className="col-md-3" style={{height: '420px', widht: '150px', border:'2px solid #c2073f',marginTop:'11px'}}>
		      				<div className="row">
